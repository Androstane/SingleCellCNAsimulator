...
if skip == 0:
    if int(args.dendropy_tree) == 1:
        ...
        [leaf_chrlen, leaf_index, chr_name_array, tree] = gen_with_tree(n, Beta, Alpha, Delta, dir, cn_num, del_rate, min_cn_size, exp_theta, amp_p, template_ref, outfile, fa_prefix, snv_rate, root_mult, whole_amp, whole_amp_rate, whole_amp_num, amp_num_geo_par)
        print("!!!!")
    else:
...
if skip == 2:
    ...
    print("Done with the first step. Reading ")
    #abs_path = os.getcwd()
    leaf_chrlen_f = save_prefix + ".leaf_chrlen.npy"
    leaf_index_f = save_prefix + ".leaf_index.npy"
    chr_name_array_f = save_prefix + ".chr_name_array.npy"
    ...
    #print(leaf_index_f)
    #print(chr_name_array_f)
    print("Tree from first step: ")
    print(tree)
    print("iterate over the tree:")
